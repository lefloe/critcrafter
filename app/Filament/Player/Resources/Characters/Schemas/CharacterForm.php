...
class CharacterForm
{
                                        ...
                                        Section::make('Natürliche Waffe')
                                            ...
                                            ->schema([
                                                ...
                                                Select::make('extensions')
                                                    ->visible(fn (Get $get) => in_array('Vierbeiner', (array) $get('racial_traits'))
                                                    )
                                                    ->label('Erweiterungen')
                                                    ->options(fn (Get $get, Set $set) => equipmentextensionshelper::getWpExtensions($get, $set)
                                                    )
                                                    ->hint('nur Vierbeinig'),
                                            ]),
    ...
    public static function limitskills($get)
    {
        ...
        $eingebungCount = collect($classabilityFields)
            ...
            ->flatten()
            ->filter(fn ($ability) => is_string($ability)
                ? $ability === 'Eingebung'
